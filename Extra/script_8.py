# Create the Jupyter notebook for demand forecasting
notebook_content = {
    "cells": [
        {
            "cell_type": "markdown",
...
# Save notebook
import json
with open('demand_forecast_train.ipynb', 'w') as f:
    json.dump(notebook_content, f, indent=2)

print("Jupyter notebook created: demand_forecast_train.ipynb")
print(f"Notebook contains {len(notebook_content['cells'])} cells with complete analysis workflow")